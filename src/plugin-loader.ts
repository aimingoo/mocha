...
const debug = Debugger('mocha:plugin-loader');
...
const castArray = utils.castArray;

import Mocha = require('./mocha');
type PluginDefinition = Mocha.PluginDefinition;
type PluginLoaderOptions = PluginLoader.PluginLoaderOptions;
/**
...
class PluginLoader {
  ...
  loaded: Map<string,Array<any>>;
  ignoredExportNames: Set<string>;
  constructor(opts?: PluginLoader.PluginLoaderOptions); // TODO: 构造方法签名?
   ...
   */
  register(pluginDef?: PluginDefinition) {
   ...
   */
  static create(opts?: PluginLoaderOptions): PluginLoader;
